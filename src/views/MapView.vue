      ...
      <div class="scrollSection">
        ...
        <div class="bg-custom-gray">
          <div class="flex items-center px-4 py-5">
            <img width="75" src="img/TransVahan/ridetruck.jpg">
            <div class="w-full ml-3">
              <div class="flex items-center justify-between">
                <div class="text-2xl mb-1">TransVahan</div>
        ...
        <div>
          <div class="flex items-center px-4 py-5">
            <img width="75" src="img/TransVahan/transit.png">
            <div class="w-full ml-3">
              <div class="flex items-center justify-between">
        ...
        <div>
          <div class="flex items-center px-4 py-5">
            <img width="75" src="img/TransVahan/miniTruck.jpg">
            <div class="w-full ml-3">
              <div class="flex items-center justify-between">
                <div class="text-2xl mb-1">MiniVahan</div>
